...
<LinkCard title="And We have Revealed to You..., Jewish Biblical Interpretation in a Comparative Context: Introduction ('01-'02)" href="" description="This exhibition presents the common scriptural heritage of Judaism, Christianity and Islam while highlighting the distinctive traditions that each of them has developed for interpreting the Bible and what they believed to be its message and meaning.">
</LinkCard>
<LinkCard title="Modern Jewry and the Arts ('00–'01)" href="" description="This exhibition presents work in a rich diversity of cultural media and genres in an effort to illustrate and explore the characteristically modern features of Jewish aesthetic production and performance beyond the traditional texts that have defined Jewish identity and existence.">
</LinkCard>
