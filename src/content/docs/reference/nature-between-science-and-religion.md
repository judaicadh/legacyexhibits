...
[Cloverleaf map on Wikimedia Commons](https://web.archive.org/web/20200901105826/https://commons.wikimedia.org/wiki/File:1581_Bunting_clover_leaf_map.jpg)
...
Tuvia's image (as well as its accompanying text) is based on one found in the influential De Sphaera Mundi of John Holywood, better known as Johannes de Sacrobosco (perhaps the 1550 edition). It is also possible that he used a derivative work that included the same image and explanation, such as [_Positiones suas physioastronomicas de sphaera coelesti_, published in Napoli in 1682](https://web.archive.org/web/20200901105826/https://books.google.co.il/books/content?id=9pVIAAAAMAAJ&pg=RA1-PA1&img=1&zoom=3&hl=en&sig=ACfU3U11HFl3yG5AdlC0cTCzLmdSDGyvLQ&ci=49%2C49%2C823%2C1280&edge=0).

*   [Image from De Sphaera Mundi](https://web.archive.org/web/20200901105826/https://commons.wikimedia.org/wiki/File:Sacrobosco-1550-B3r.png)
    
*   [Bibliographic information about De Sphaera Mundi](https://web.archive.org/web/20200901105826/https://commons.wikimedia.org/wiki/Category:De_sphaera_mundi)
    
*   [Positiones suas physioastronomicas de sphaera coelesti: facsimile](https://web.archive.org/web/20200901105826/https://archive.org/details/bub_gb_4rO1t_NKaHkC)
...
[Top left: Discover Magazine Razib Khan "Genetics & the Jews" June 6, 2010](https://web.archive.org/web/20200901105826/https://www.library.upenn.edu/collections/online-exhibits/nature-between-science-and-religion/genetics-and-jewish-identity)
...
Nothing is known of any Jewish acquaintance with the Image du monde until, out of the blue, an abbreviated Yiddish version appears in print in 1718/9 under the title Sēfer yedîʿat ʿôlām (reprinted: Altona, 1727/8). To this day, the translator/redactor remains anonymous.   
